...
Public Class Form15
    ...
    Dim reser_Articulo As String = ""
    Dim reser_accion As Byte = 0
    Public Sub New(ByVal v_Articulo As String, ByVal v_accion As Byte)
        InitializeComponent()
        reser_Articulo = v_Articulo
...
#Region "controles Text"
    ...
    Private Sub MetroTextBox0_CausesValidationChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MetroTextBox0.CausesValidationChanged
...
#End Region
    ...
    Private Sub Form15_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If reser_accion = 2 Then
            MetroTextBox0.Text = reser_Articulo
        Else
            MetroTextBox0.Text = ""
        End If
    ...
    Private Sub MetroButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroButton4.Click
        ...
        If MetroTextBox0.Text.Trim = "" Then
            modalidad = 1
            nuevo_articulo()
        Else
    ...
    Private Sub MetroTextBox4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroTextBox4.Click
    ...
    Private Sub MetroTextBox24_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroTextBox24.Click
    ...
    Private Sub MetroButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroButton1.Click
        Try
            ...
            If MetroTextBox0.Text.Trim = "" Then
                MetroFramework.MetroMessageBox.Show(Me, "El número de Artículo no debe ser nulo", rsv_modulo, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            v0 = MetroTextBox0.Text.Trim
            If MetroTextBox1.Text.Trim <> "" Then
                v1 = MetroTextBox1.Text.Trim
            End If
            If MetroTextBox2.Text.Trim <> "" Then
                v2 = MetroTextBox2.Text.Trim
            End If
            If MetroTextBox3.Text.Trim <> "" Then
                v3 = MetroTextBox3.Text.Trim
            End If
            If MetroTextBox4.Text.Trim <> "" Then
                v4 = CDbl(MetroTextBox4.Text.Trim)
            End If
            If MetroTextBox7.Text.Trim <> "" Then
                v7 = CDbl(MetroTextBox7.Text.Trim)
            End If
            If MetroTextBox8.Text.Trim <> "" Then
                v8 = CDbl(MetroTextBox8.Text.Trim)
            End If
            ...
            If MetroTextBox9.Text.Trim <> "" Then
                v9 = CDbl(MetroTextBox9.Text.Trim)
            End If

            If v9 <> 10.5 And v9 <> 21 And v9 <> 0 Then
                MetroFramework.MetroMessageBox.Show(Me, "Porcentaje de Alícuota Válidos (10.50/21.00/0) ", rsv_Modulo, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            ...
            If MetroTextBox20.Text.Trim <> "" Then
                v20 = MetroTextBox20.Text.Trim
            End If
            If MetroTextBox21.Text.Trim <> "" Then
                v21 = MetroTextBox21.Text.Trim
            End If
            ...
            If MetroTextBox24.Text.Trim <> "" Then
                v24 = CInt(MetroTextBox24.Text.Trim)
            End If
            ...
            If modalidad = 1 Then
                ...
                Sql = Sql & "Sector,Estanteria,Existencia,ExisMini,Rubro,UltimoPrecio,"
                Sql = Sql & "Au,Af,Ah,Estado) Values ("
                Sql = Sql & "'" & v0 & "','" & v1 & "','" & v2 & "','" & v3 & "'," & v4 & ","
                Sql = Sql & "" & v7 & "," & v8 & "," & v5 & "," & v9 & ","
                Sql = Sql & "" & v10 & "," & v11 & "," & v12 & "," & v13 & "," & v14 & ","
                Sql = Sql & "" & v15 & "," & v16 & "," & v17 & "," & v18 & "," & v19 & ","
                Sql = Sql & "'" & v20 & "','" & v21 & "'," & v22 & "," & v23 & "," & v24 & ",'" & j2 & "',"
                Sql = Sql & "" & j1 & ",'" & j2 & "','" & j3 & "',0)"
            End If

            If modalidad = 2 Then
                Sql = "Update Articulos SET CodigoProveedor='" & v1 & "',CodigoBarra='" & v2 & "',Detalle='" & v3 & "',Proveedor=" & v4 & ","
                Sql = Sql & "PrecioCosto=" & v7 & ",Ganancia=" & v8 & ",AplicaIva=" & v5 & ",Alicuota=" & v9 & ","
                ...
                Sql = Sql & "Sector='" & v20 & "',Estanteria='" & v21 & "',Existencia=" & v22 & ",ExisMini=" & v23 & ",Rubro=" & v24 & ","
                Sql = Sql & "Au=" & j1 & ",Af='" & j2 & "',Ah='" & j3 & "',UltimoPrecio='" & j2 & "',Estado=0 "
