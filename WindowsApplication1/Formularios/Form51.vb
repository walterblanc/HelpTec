...
Public Class Form51
    ...
    Private Sub Form51_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub hacerReporte()
        ...
        Try
            ...
            tabla = New DataTable("reportesLibroCompras")
            ...
            insSql = "Select * from Iva_Compras Where Estado = 0 And FechaDeImputacion >= '" & xFechaDesde & "' And FechaDeImputacion <= '" & xFechaHasta & "' Order By FechaDeImputacion,TipoDeComprobante,Letra,NumeroDeComprobante"
            ...
            If drRecordSet2.HasRows Then 'Tiene filas
                Do While drRecordSet2.Read
                    ...
                    registro("FechaImputacion") = FormatDateTime(drRecordSet2("FechaDeImputacion").ToString, DateFormat.ShortDate)

                    registro("TipoComprobante") = drRecordSet2("TipoDeComprobante").ToString
                    registro("Responsable") = parametroSistema(2, Val(drRecordSet2("TipoResponsable").ToString))


                    registro("LetraComprobante") = drRecordSet2("Letra").ToString
                    registro("NumeroComprobante") = drRecordSet2("NumeroDeComprobante").ToString
                    ...
                    registro("NoGravados") = drRecordSet2("ConceptosNoGravados").ToString
                    ...
                    If drRecordSet2("TipoDeComprobante").ToString = "FA" Or drRecordSet2("TipoDeComprobante").ToString = "ND" Then
            ...
            Dim mi_CryResumen As New CrLibroIvaCompras()
            'Le indicamos al reporte que tome los datos
            'del DataSet
            mi_CryResumen.SetDataSource(dts.Tables("reportesLibroCompras"))
            ...
            If drRecordSet2.HasRows Then 'Tiene filas
                Do While drRecordSet2.Read
                    With excel
                        ...
                        .Cells(i, 2) = FormatDateTime(drRecordSet2("FechaDeImputacion").ToString, DateFormat.ShortDate)

                        .Cells(i, 3) = drRecordSet2("TipoDeComprobante").ToString
                        .Cells(i, 4) = parametroSistema(2, Val(drRecordSet2("TipoResponsable").ToString))


                        .Cells(i, 5) = drRecordSet2("Letra").ToString
                        .Cells(i, 6) = drRecordSet2("NumeroDeComprobante").ToString
