...
Public Class Form48
    ...
    Private Sub Form48_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        MetroTextBox8.Text = ""
        cargar_datagrid()
        MetroTextBox8.Focus()
    End Sub
    Private Sub cargar_datagrid()
        ...
        If MetroTextBox8.Text.Trim = "" Then
            Sql = "Select TOP(30) * From Codigos_Bancarios WHERE (Estado = 0) Order by Codigo"
        End If
        If MetroTextBox8.Text.Trim <> "" Then
            Dim f As String = ""
            f = MetroTextBox8.Text.Trim
            Sql = "Select * From Codigos_Bancarios WHERE (Estado = 0) and (Detalle like '%" & f & "%' ) Order by Codigo"
        End If
        If P = True Then
            Sql = "Select TOP(30) *  From Codigos_Bancarios WHERE (Estado = 0) Order by Codigo"
            P = False
            ...
            Do While drRecordSet.Read
                With metroGrid1
                    ...
                    If Val(drRecordSet("DebCre").ToString) = 1 Then
                        .Item(2, h).Value = "Debito"
                    End If
                    If Val(drRecordSet("DebCre").ToString) = 2 Then
                        .Item(2, h).Value = "Credito"
                    End If
    ...
    Private Sub EliminarToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EliminarToolStripMenuItem.Click
        ...
        If (metroGrid1.CurrentRow IsNot Nothing) Then
            Dim x As Integer = Val(metroGrid1.CurrentRow.Cells(0).Value)
            cambio_estado(x)
            cargar_datagrid()
        End If
    ...
    Private Sub cambio_estado(ByVal x As String)
        Try
            ...
            Sql = "Update Codigos_Bancarios SET Estado=9,"
            Sql = Sql & "FechaBaja='" & j2 & "',HoraBaja='" & j3 & "',UsuarioBaja=" & j1 & " WHERE Codigo= '" & x & "' "
    ...
    Private Sub metroGrid1_CellMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles metroGrid1.CellMouseDoubleClick
        ...
        numero = Val(metroGrid1.Rows(e.RowIndex).Cells(0).Value)
        If rsv_Io = 0 Then
            Dim Formulario_open As New Form49(numero, 2)
            Formulario_open.ShowDialog()
            cargar_datagrid()
        End If
        If rsv_Io = 1 Then
    ...
    Private Sub ModificarToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ModificarToolStripMenuItem.Click
        ...
        If (metroGrid1.CurrentRow IsNot Nothing) Then
            Dim numero As Integer = Val(metroGrid1.CurrentRow.Cells(0).Value)
            Dim Formulario_open As New Form49(numero, 2)
            Formulario_open.ShowDialog()
    ...
    Private Sub ToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem1.Click
        Dim Formulario_open As New Form49(0, 1)
        Formulario_open.ShowDialog()
        cargar_datagrid()
    End Sub
