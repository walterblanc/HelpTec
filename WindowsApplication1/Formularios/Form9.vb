...
Public Class Form9
    ...
    Private Sub cargar_datagrid()
        ...
        If MetroTextBox8.Text.Trim = "" Then
            Sql = "Select TOP(30) * From Proveedores WHERE (Estado = 0) Order by RazonSocial"
        End If
        If MetroTextBox8.Text.Trim <> "" Then
            Dim f As String = ""
            f = MetroTextBox8.Text.Trim
            If MetroRadioButton1.Checked = True Then
                Sql = "Select * From Proveedores WHERE (Estado = 0) and (RazonSocial like '%" & f & "%' ) Order by RazonSocial"
            End If
            If MetroRadioButton2.Checked = True Then
                Sql = "Select * From Proveedores WHERE (Estado = 0) and (Comercial like '%" & f & "%' ) Order by Comercial"
            End If
        End If
    ...
    Private Sub MetroLink1_Click(sender As System.Object, e As System.EventArgs) Handles MetroLink1.Click
        Dim Formulario_open As New Form10(0, 1)
    ...
    Private Sub cambio_estado(ByVal x As Double)
        Try
            ...
            Sql = "Update Proveedores SET Estado=9,"
    ...
    Private Sub MetroLink4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroLink4.Click
        ...
        If (metroGrid1.CurrentRow IsNot Nothing) Then
            Dim numero As Double = metroGrid1.CurrentRow.Cells(0).Value
            Dim Formulario_open As New Form42(numero)
            Formulario_open.ShowDialog()
    ...
    Private Sub MetroLink5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroLink5.Click
        ...
        If (metroGrid1.CurrentRow IsNot Nothing) Then
            Dim x As Double = metroGrid1.CurrentRow.Cells(0).Value
            Dim Formulario_open As New Form70(x)
            Formulario_open.ShowDialog()
