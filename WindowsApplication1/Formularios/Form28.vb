...
Public Class Form28
    ...
    Private Sub Form28_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        MetroTextBox8.Text = ""
        cargar_datagrid()
        MetroTextBox8.Focus()
    End Sub
    Private Sub cargar_datagrid()
        ...
        If MetroTextBox8.Text.Trim = "" Then
            Sql = "Select * From Remitos WHERE (Orden=1) Order by RemitoNro DESC"
        End If
        If MetroTextBox8.Text.Trim <> "" Then
            Dim f As String = ""
            f = MetroTextBox8.Text.Trim
            Sql = "Select * From Remitos WHERE (Orden=1) And (RazonSocial like '%" & f & "%' ) Order by RemitoNro DESC"
        End If
        ...
        If drRecordSet.HasRows Then 'Tiene filas
            Do While drRecordSet.Read
                With metroGrid1
                    ...
                    .Item(1, h).Value = drRecordSet("RemitoNro").ToString
