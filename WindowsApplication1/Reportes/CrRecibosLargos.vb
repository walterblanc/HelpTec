...
Public Class CrRecibosLargos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrRecibosLargos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRecibosLargos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRecibosLargos = New CrRecibosLargos()
        rpt.Site = Me.Site
        Return rpt
    End Function
