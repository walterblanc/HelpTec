...
Public Class CrValoresCartera
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrValoresCartera.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrValoresCartera
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrValoresCartera = New CrValoresCartera()
        rpt.Site = Me.Site
        Return rpt
    End Function
