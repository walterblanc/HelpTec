...
Public Class CrComprobantesB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrComprobantesB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrComprobantesB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrComprobantesB = New CrComprobantesB()
        rpt.Site = Me.Site
        Return rpt
    End Function
