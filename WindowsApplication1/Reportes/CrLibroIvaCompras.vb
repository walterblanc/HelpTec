...
Public Class CrLibroIvaCompras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrLibroIvaCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLibroIvaCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLibroIvaCompras = New CrLibroIvaCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
