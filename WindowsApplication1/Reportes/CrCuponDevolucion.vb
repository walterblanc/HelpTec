...
Public Class CrCuponDevolucion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrCuponDevolucion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrCuponDevolucion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCuponDevolucion = New CrCuponDevolucion()
        rpt.Site = Me.Site
        Return rpt
    End Function
