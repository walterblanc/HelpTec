...
Public Class CrComprobantesA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrComprobantesA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrComprobantesA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrComprobantesA = New CrComprobantesA()
        rpt.Site = Me.Site
        Return rpt
    End Function
