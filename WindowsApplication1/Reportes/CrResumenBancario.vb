...
Public Class CrResumenBancario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Appgescom.CrResumenBancario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrResumenBancario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrResumenBancario = New CrResumenBancario()
        rpt.Site = Me.Site
        Return rpt
    End Function
