...
Class LoginTicket
    ...
    ByVal argVerbose As Boolean _
        ...
        Try
            ...
            xmlNodoGenerationTime.InnerText = DateTime.Now.AddMinutes(-30).ToString("s")
            xmlNodoExpirationTime.InnerText = DateTime.Now.AddMinutes(+120).ToString("s")
        ...
        Try
            ...
            If rsv_Afip_Homolog = 0 Then
                servicioWsaa.Url = "https://wsaa.afip.gov.ar/ws/services/LoginCms?WSDL"
            End If
...
Class Obtener_Ticket_Afip
    ...
    Const DEFAULT_URLWSAAWSDL_PROD As String = "https://wsaa.afip.gov.ar/ws/services/LoginCms?WSDL"

    Const DEFAULT_SERVICIO As String = "wsfe"
    Const DEFAULT_CERTSIGNER As String = "C:\OpenSSL-Win32\bin\certificado_laarena.pfx"
    ...
    ''' <remarks></remarks>
    Public Shared Function Obtener_Ticket_Afip_Main(ByVal args As String()) As Integer
        ...
        If rsv_Afip_Homolog = 1 Then
            strUrlWsaaWsdl = DEFAULT_URLWSAAWSDL
        Else
            strUrlWsaaWsdl = DEFAULT_URLWSAAWSDL_PROD
        End If
        ...
        Try
            ...
            Call almacenar_ticket(objTicketRespuesta.Token, objTicketRespuesta.Sign, CStr(objTicketRespuesta.GenerationTime), CStr(objTicketRespuesta.ExpirationTime), objTicketRespuesta.Service, CStr(objTicketRespuesta.UniqueId), strTicketRespuesta)
            ' Call almacenar_ticket(objTicketRespuesta.Token, objTicketRespuesta.Sign, objTicketRespuesta.GenerationTime.ToString, objTicketRespuesta.ExpirationTime.ToString, objTicketRespuesta.Service, CStr(objTicketRespuesta.UniqueId), strTicketRespuesta)
        ...
        Catch excepcionAlObtenerTicket As Exception
            Throw New Exception("***Error al firmar: " & excepcionAlObtenerTicket.Message)
            Return -10
    ...
    Shared Sub almacenar_ticket(ByVal arg1 As String, ByVal arg2 As String, ByVal arg3 As String, _
                                ByVal arg4 As String, ByVal arg5 As String, ByVal arg6 As String, ByVal arg7 As String)
        ...
        Try
            ...
            InsSql = ""
            InsSql = "UpDate AfipToken SET Token='" & arg1 & "',Sign='" & arg2 & "',GenerTime='" & arg3 & "',"
            InsSql = InsSql & "ExpirTime='" & arg4 & "',Service='" & arg5 & "',UniqId='" & arg6 & "',Ticket='" & arg7 & "' WHERE ID = 1"
            ...
            Dim File_Ticket As String = ""
            File_Ticket = rsv_Afip_Tickets & "\" & "TA.XML"


            If System.IO.File.Exists(File_Ticket) Then
                My.Computer.FileSystem.DeleteFile(File_Ticket)
            End If

            Dim ruta As String = File_Ticket

            'If System.IO.File.Exists("c:\TicketAfip\TA.XML") Then
            '    My.Computer.FileSystem.DeleteFile("c:\TicketAfip\TA.XML")
            'End If

            'Dim ruta As String = "c:\TicketAfip\TA.XML"
            ...
            ConSql.Close()
        Catch excepcionAlmacenarTicket As Exception
            Throw New Exception(excepcionAlmacenarTicket.Message & " " & excepcionAlmacenarTicket.StackTrace)
